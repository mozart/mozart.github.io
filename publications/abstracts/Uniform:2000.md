...
[Postscript](http://www.ps.uni-sb.de/PapersOz/ProgrammingSysLab/Uniform:2000.ps.gz)

[BibTeX Entry](http://www.ps.uni-sb.de/PapersOz/abstracts/Uniform:2000.bib)
...
in the -calculus with weak call-by-value reduction
...
into the applicative core of the -calculus
and show that
...
of the -calculus (introduced in the paper) into the applicative core 
of the -calculus which is of its own interest.
