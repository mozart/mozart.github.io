...
makefile(%%contibution
         ...
         version : '0.1.3'
         uri     : 'x-ozlib://chorus/solver/km-leda'
         mogul   : 'mogul:/chorus/dominance-solver-km-leda'

         info_html:
"This package provides an implementation of the Solver for 
normal dominance constraints described in <a
href=\"http://ps.uni-sb.de/Papers/abstracts/eff-dom.html\">An Efficient
Graph Algorithm for Dominance Constraints</a>.
